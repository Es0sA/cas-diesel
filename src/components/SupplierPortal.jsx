...
import { UserCheck, Truck, ShieldCheck, DollarSign, CheckCircle2, Lock, Plus, AlertCircle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="max-w-3xl mb-8">
          ...
          <h2 className="text-2xl sm:text-4xl font-extrabold text-cas-slate tracking-tight">
            Marketer Pricing & Fleet Dispatch Desk
          </h2>
          <p className="text-base text-cas-muted mt-2">
            Set your daily spot price per litre, review confirmed escrow allocations, and assign registered drivers to outbound tanker trips.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 bg-white p-6 sm:p-8 rounded-2xl border-2 border-cas-border shadow-sm">
            ...
            <form onSubmit={handleUpdatePricing} className="space-y-5">
              <div>
                ...
                <span className="text-xs text-cas-muted mt-1 block">
                  Today's competitive benchmark: ₦1,175 - ₦1,185/L
                </span>
              </div>
            ...
            <div className="mt-6 pt-5 border-t border-slate-200 text-xs text-cas-muted space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold text-cas-slate">Stanbic IBTC Bank Plc</span>
              </div>
            </div>
          </div>

          {/* Column 2: Order Queue & Driver Assignment */}
          <div className="lg:col-span-8 space-y-6">
            ...
            {/* Registered Driver Fleet List */}
            <div className="bg-white p-6 rounded-2xl border-2 border-cas-border">
              <div className="flex items-center justify-between mb-4">
                <h4 className="font-extrabold text-base text-cas-slate flex items-center gap-2">
                  <Truck className="w-4 h-4 text-cas-amberDark" aria-hidden="true" />
                  <span>Registered Drivers Under Your Fleet</span>
                </h4>
                <button
                  type="button"
                  className="text-xs font-bold text-cas-slate hover:text-black flex items-center gap-1 underline"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                  <span className="font-bold text-cas-slate block">Suleiman Tanko</span>
                  <span className="font-mono text-cas-muted">LSR-492-XA | 33,000L</span>
                  <span className="text-[11px] text-cas-green font-semibold block mt-1">Status: On Active Delivery</span>
                </div>
                <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                  <span className="font-bold text-cas-slate block">Emeka Okonkwo</span>
                  <span className="font-mono text-cas-muted">KJA-112-XC | 33,000L</span>
                  <span className="text-[11px] text-slate-500 font-semibold block mt-1">Status: Available at Depot</span>
                </div>
                <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                  <span className="font-bold text-cas-slate block">Murtala Bello</span>
                  <span className="font-mono text-cas-muted">KTU-884-YD | 22,000L</span>
                  <span className="text-[11px] text-slate-500 font-semibold block mt-1">Status: Available at Depot</span>
                </div>
              </div>
            </div>
